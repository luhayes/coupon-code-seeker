...
Consumer credit, including short-term lenders. Every page here leads with the representative example and the APR, never with a promotional rate.

2 stores, 5 active offers. Every offer is checked against the merchant's own pages — we do not list a code we could not confirm.
